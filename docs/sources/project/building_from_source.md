...
```bash
export GOPATH=`pwd`
go get github.com/aergio/grafana
```
...
You may see an error such as: `package github.com/aergoio/grafana: no buildable Go source files`. This is just a warning, and you can proceed with the directions.
