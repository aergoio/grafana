...
import (
	...
	"github.com/aergoio/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/aergoio/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/aergoio/grafana/pkg/cmd/grafana-cli/services"
	"github.com/aergoio/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/aergoio/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
